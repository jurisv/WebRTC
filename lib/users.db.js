        ...
        users = {
            ...
            bindChanges: function(){
                ...
                if(!io.users) {
                    ...
                    io.users = firebase.child('/users');

                    io.users.on('child_added', function (childSnapshot, prevChildName) {
                    ...
                    io.users.on('child_removed', function (childSnapshot, prevChildName) {
                        if (childSnapshot.val() && childSnapshot.val() != undefined) {
                            var data = childSnapshot.val();
                    ...
                    io.users.on('child_changed', function (childSnapshot, prevChildName) {
                        if (childSnapshot.val() && childSnapshot.val() != undefined) {
                            var data = childSnapshot.val();
                    ...
                    io.users.on('child_moved', function (childSnapshot, prevChildName) {
                        if (childSnapshot.val() && childSnapshot.val() != undefined) {
                            var data = childSnapshot.val();
