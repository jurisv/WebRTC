        ...
        securityroles = {
            ...
            bindChanges: function(){
                ...
                if(!io.securityroles) {
                    ...
                    io.securityroles = firebase.child('/securityroles');

                    io.securityroles.on('child_added', function (childSnapshot, prevChildName) {
                    ...
                    io.securityroles.on('child_removed', function (childSnapshot, prevChildName) {
                        if (childSnapshot.val() && childSnapshot.val() != undefined) {
                            var data = childSnapshot.val();
                    ...
                    io.securityroles.on('child_changed', function (childSnapshot, prevChildName) {
                        if (childSnapshot.val() && childSnapshot.val() != undefined) {
                            var data = childSnapshot.val();
                    ...
                    io.securityroles.on('child_moved', function (childSnapshot, prevChildName) {
                        if (childSnapshot.val() && childSnapshot.val() != undefined) {
                            var data = childSnapshot.val();
