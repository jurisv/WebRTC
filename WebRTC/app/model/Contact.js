/**
 * @class WebRTC.model.Contact
 * @extend Ext.data.Model
 * Model which contains all the informations
 * related to a single phone contact.
 */
Ext.define('WebRTC.model.Contact', {
    extend: 'Ext.data.Model',
    config: {
        idProperty: 'jid',
        fields: [
            { name: 'jid',              type: 'string'                            },
            { name: 'is_xmpp',          type: 'boolean', defaultValue: true       },
            { name: 'xmpp_name',        type: 'string'                            },    // The associated XMPP client
            { name: 'xmpp_provider',    type: 'string'                            },
            { name: 'group',            type: 'string', convert: function(v, record){
            ...
            { name: 'vCard',            type: 'object'                            },     // The raw vCard object
            ...
            { name: 'email_pref',     type: 'string', convert: function(v, record){
            ...
            // This field is choose from all the informations we have
            { name: 'display_name', type: 'string', convert: function(v, record){
